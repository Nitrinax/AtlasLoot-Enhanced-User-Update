...
data["Alchemy"] = {
	...
	items = {
		...
		{	--AlchemyResearch
			...
			-- },
			[WOD_DIFF] = {
				{ 1, 118700, 175880 },	-- Secrets of Draenor Alchemy (Learnt by item 109558)
			},
			-- [MOP_DIFF] = {
			-- 	{ 1, 000000, 000000 }, -- XXXXXXXXXX
			-- },
			...
			-- },
			[WOTLK_DIFF] = {
				{ 1, 115460, 60893 }, -- Northrend Alchemy Research
			},
			-- [BC_DIFF] = {
			-- 	{ 1, 000000, 000000 }, -- XXXXXXXXXX
			-- },
		...
		{	--AlchemyAntiVenom
			name = GetSpellInfo(7932),
			[SL_DIFF] = {
				{ 1, 171301, 307100 }, -- Spiritual Anti-Venom
			},
			-- [BFA_DIFF] = {
			-- 	{ 1, 000000, 000000 }, -- XXXXXXXXXX
			-- },
			...
			-- },
			[WOD_DIFF] = {
				{ 1, 116979, 172541, [ATLASLOOT_IT_AMOUNT1] = "4+" },	-- Blackwater Anti-Venom (Learnt by item 111364)
			},
			-- [MOP_DIFF] = {
			-- 	{ 1, 000000, 000000 }, -- XXXXXXXXXX
			-- },
			...
			-- },
			[CLASSIC_DIFF] = {
				{ 1, 6452, 7934 }, -- Anti-Venom				
				{ 2, 6453, 7935 }, -- Strong Anti-Venom
				{ 3, 19440, 23787 }, -- Powerful Anti-Venom
			}
		},
		{	--AlchemyCauldrons
			name = GetSpellInfo(314167),
			[SL_DIFF] = {
				{ 1, 171284, 307087 }, -- Eternal Cauldron
			},
			[BFA_DIFF] = {
				{ 1, 162519, 276975 }, -- Mystical Cauldron
				{ 2, 162519, 276976 }, -- Mystical Cauldron
				{ 3, 162519, 276977 }, -- Mystical Cauldron
				{ 5, 168656, 298862 }, -- Greater Mystical Cauldron
				{ 6, 168656, 298863 }, -- Greater Mystical Cauldron
				{ 7, 168656, 298864 }, -- Greater Mystical Cauldron
			},
			[LEGION_DIFF] = {
			...
			-- },
			[CATA_DIFF] = {				
				{ 1, 62288, 92643 },	-- Cauldron of Battle : =ds=#sr# 525 : =ds=AtlasLoot_IngameLocales["Guild"] - AtlasLoot["Friendly"]
				{ 2, 65460, 92688 },	-- Big Cauldron of Battle : =ds=#sr# 525 : =ds=AtlasLoot_IngameLocales["Guild"] - AtlasLoot["Friendly"]
			},
			-- [WOTLK_DIFF] = {
			-- 	{ 1, 000000, 000000 }, -- XXXXXXXXXX
			-- },
			[BC_DIFF] = {
				{ 1, 32839, 41458 },	-- Cauldron of Major Arcane Protection Potion : =ds=#sr# 300 : =ds=AtlasLoot["Discovery"]
				{ 2, 32849, 41500 },	-- Cauldron of Major Fire Protection Potion : =ds=#sr# 300 : =ds=AtlasLoot["Discovery"]
				{ 3, 32850, 41501 },	-- Cauldron of Major Frost Protection Potion : =ds=#sr# 300 : =ds=AtlasLoot["Discovery"]
				{ 4, 32851, 41502 },	-- Cauldron of Major Nature Protection Potion : =ds=#sr# 300 : =ds=AtlasLoot["Discovery"]
				{ 5, 32852, 41503 },	-- Cauldron of Major Shadow Protection Potion : =ds=#sr# 300 : =ds=AtlasLoot["Discovery"]
			},
			-- [CLASSIC_DIFF] = {
			-- 	{ 1, 000000, 000000 }, -- XXXXXXXXXX
			-- }
		...
		{	--AlchemyPotions
			name = AL["Potions"],
			[SL_DIFF] = {
				{ 1, 171351, 307384 }, -- Potion of Deathly Fixation
				{ 2, 171350, 307383 }, -- Potion of Divine Awakening
				{ 3, 171352, 307381 }, -- Potion of Empowered Exorcisms
				{ 4, 171271, 307094 }, -- Potion of Hardened Shadows
				{ 5, 171349, 307382 }, -- Potion of Phantom Fire
				{ 6, 176811, 322301 }, -- Potion of Sacrificial Anima
				{ 7, 171272, 307095 }, -- Potion of Spiritual Clarity
				{ 9, 171270, 307093 }, -- Potion of Spectral Agility
				{ 10, 171273, 307096 }, -- Potion of Spectral Intellect
				{ 11, 171274, 307097 }, -- Potion of Spectral Stamina
				{ 12, 171275, 307098 }, -- Potion of Spectral Strength
				{ 16, 171267, 301578 }, -- Spiritual Healing Potion
				{ 17, 171268, 301683 }, -- Spiritual Mana Potion
				{ 18, 171269, 261423 }, -- Spiritual Rejuvenation Potion
				{ 20, 171264, 295084 }, -- Potion of Shaded Sight
				{ 21, 171263, 256134 }, -- Potion of Soul Purity
				{ 22, 171370, 256133 }, -- Potion of Specter Swiftness
				{ 23, 171266, 261424 }, -- Potion of the Hidden Spirit
				{ 24, 184090, 344316 }, -- Potion of the Psychopomp's Speed
				{ 25, 183823, 342887 }, -- Potion of Unhindered Passing
			},
			[BFA_DIFF] = {
				...
				{ 109, 152494, 252382 }, -- Coastal Healing Potion
				{ 110, 152494, 252383 }, -- Coastal Healing Potion
				{ 111, 152494, 252384 }, -- Coastal Healing Potion
				{ 113, 152495, 252385 }, -- Coastal Mana Potion
				{ 114, 152495, 252386 }, -- Coastal Mana Potion
				{ 115, 152495, 252387 }, -- Coastal Mana Potion
				{ 116, 163082, 252388 }, -- Coastal Rejuvenation Potion
				{ 117, 163082, 252389 }, -- Coastal Rejuvenation Potion
				{ 118, 163082, 252390 }, -- Coastal Rejuvenation Potion
				{ 116, 152496, 252391 }, -- Demitri's Draught of Deception
				{ 120, 152496, 252392 }, -- Demitri's Draught of Deception
				{ 121, 152496, 252393 }, -- Demitri's Draught of Deception
				{ 123, 152497, 252394 }, -- Lightfoot Potion
				{ 124, 152497, 252395 }, -- Lightfoot Potion
				{ 125, 152497, 252396 }, -- Lightfoot Potion
				{ 201, 169451, 301310 }, -- Abyssal Healing Potion
				{ 202, 169451, 301311 }, -- Abyssal Healing Potion
				{ 203, 169451, 301312 }, -- Abyssal Healing Potion
				{ 205, 168506, 298744 }, -- Potion of Focused Resolve
				{ 206, 168506, 298745 }, -- Potion of Focused Resolve
				{ 207, 168506, 298746 }, -- Potion of Focused Resolve
				{ 209, 168529, 298726 }, -- Potion of Empowered Proximity
				{ 210, 168529, 298727 }, -- Potion of Empowered Proximity
				{ 211, 168529, 298728 }, -- Potion of Empowered Proximity
				{ 213, 169299, 300749 }, -- Potion of Unbridled Fury
				{ 214, 169299, 300750 }, -- Potion of Unbridled Fury
				{ 215, 169299, 300751 }, -- Potion of Unbridled Fury
				{ 216, 169300, 300752 }, -- Potion of Wild Mending
				{ 217, 169300, 300753 }, -- Potion of Wild Mending
				{ 218, 169300, 300754 }, -- Potion of Wild Mending
				{ 221, 168499, 298747 }, -- Superior Battle Potion of Stamina
				{ 222, 168499, 298748 }, -- Superior Battle Potion of Stamina
				{ 223, 168499, 298749 }, -- Superior Battle Potion of Stamina
				{ 225, 168489, 298729 }, -- Superior Battle Potion of Agility
				{ 226, 168489, 298730 }, -- Superior Battle Potion of Agility
				{ 227, 168489, 298731 }, -- Superior Battle Potion of Agility
				{ 301, 168498, 298741 }, -- Superior Battle Potion of Intellect
				{ 302, 168498, 298742 }, -- Superior Battle Potion of Intellect
				{ 303, 168498, 298743 }, -- Superior Battle Potion of Intellect
				{ 305, 168500, 298750 }, -- Superior Battle Potion of Strength
				{ 306, 168500, 298751 }, -- Superior Battle Potion of Strength
				{ 307, 168500, 298752 }, -- Superior Battle Potion of Strength
				{ 309, 168501, 298734 }, -- Superior Steelskin Potion
				{ 310, 168501, 298735 }, -- Superior Steelskin Potion
				{ 311, 168501, 298736 }, -- Superior Steelskin Potion
				{ 313, 166270, 287447 }, -- Potion of the Unveiling Eye
				{ 314, 166270, 287448 }, -- Potion of the Unveiling Eye
				{ 315, 166270, 287449 }, -- Potion of the Unveiling Eye
			},
			[LEGION_DIFF] = {
				-- { #, itemID, spellID },
				...
				-- 7.2.0
				{ 109, 142117, 229217 }, -- Potion of Prolonged Power
				{ 110, 142117, 229218 }, -- Potion of Prolonged Power
				{ 111, 142117, 229220 }, -- Potion of Prolonged Power
				-- 7.3.0
				{ 113, 151608, 247619 }, -- Lightblood Elixir
				{ 114, 151608, 247620 }, -- Lightblood Elixir
				{ 115, 151608, 247622 }, -- Lightblood Elixir
				{ 116, 151609, 247688 }, -- Tears of the Naaru
				{ 117, 151609, 247690 }, -- Tears of the Naaru
				{ 118, 151609, 247691 }, -- Tears of the Naaru
				{ 120, 152615, 251646 }, -- Astral Healing Potion
				{ 121, 152615, 251651 }, -- Astral Healing Potion
				{ 122, 152615, 251658 }, -- Astral Healing Potion
				{ 124, 136653, 221690 }, -- Silvery Salve
			},
			[WOD_DIFF] = {
				{ 1, 109222, 156582 },	-- Draenic Mana Potion (Learnt by item 109558)
				{ 2, 109223, 172540, [ATLASLOOT_IT_AMOUNT1] = "4+" },	-- Healing Tonic (Learnt by item 111364)
				{ 3, 116268, 175865 },	-- Draenic Invisibility Potion (Learnt by item 109558)
				{ 4, 116276, 175867 },	-- Draenic Living Action Potion (Learnt by item 109558)
				{ 5, 109226, 156584, [PRICE_EXTRA_ITTYPE] = "118700:1" },	-- Draenic Rejuvenation Potion (Sold, Ashran)
				{ 6, 116266, 175853 },	-- Draenic Swiftness Potion (Learnt by item 109558)
				{ 7, 118704, 175868 },	-- Pure Rage Potion (Learnt by item 109558)
			...
			[CATA_DIFF] = {
				...
				{ 20, 58142, 80479 },	-- Deathblood Venom
			},
			[WOTLK_DIFF] = {
			...
			[CLASSIC_DIFF] = {
				...
				{ 117, 13506, 17634 }, -- Potion of Petrification
			},
		},
		{	--AlchemyElixirs
			name = AL["Elixirs"],
		...
		{	--AlchemyFlasks
			...
			[LEGION_DIFF] = {
				{ 1, 127847, 188337 }, -- Flask of the Whispered Pact
				{ 2, 127847, 188338 }, -- Flask of the Whispered Pact
				{ 3, 127847, 188339 }, -- Flask of the Whispered Pact
				{ 5, 127848, 188340 }, -- Flask of the Seventh Demon
				{ 6, 127848, 188341 }, -- Flask of the Seventh Demon
				{ 7, 127848, 188342 }, -- Flask of the Seventh Demon
				{ 9, 127849, 188343 }, -- Flask of the Countless Armies
				{ 10, 127849, 188344 }, -- Flask of the Countless Armies
				{ 11, 127849, 188345 }, -- Flask of the Countless Armies
				{ 13, 127850, 188346 }, -- Flask of Ten Thousand Scars
				{ 14, 127850, 188347 }, -- Flask of Ten Thousand Scars
				{ 15, 127850, 188348 }, -- Flask of Ten Thousand Scars
			},
			[WOD_DIFF] = {
				{ 1, 109145, 156561, [PRICE_EXTRA_ITTYPE] = "118700:1", [ATLASLOOT_IT_AMOUNT1] = 5 },	-- Draenic Agility Flask (Sold, Ashran)
				{ 2, 109147, 156563, [PRICE_EXTRA_ITTYPE] = "118700:1", [ATLASLOOT_IT_AMOUNT1] = 5 },	-- Draenic Intellect Flask (Sold, Ashran)
				{ 3, 109152, 156568, [PRICE_EXTRA_ITTYPE] = "118700:1", [ATLASLOOT_IT_AMOUNT1] = 5 },	-- Draenic Stamina Flask (Sold, Ashran)
				{ 4, 109148, 156564, [PRICE_EXTRA_ITTYPE] = "118700:1", [ATLASLOOT_IT_AMOUNT1] = 5 },	-- Draenic Strength Flask (Sold, Ashran)
				{ 6, 109153, 156569, [PRICE_EXTRA_ITTYPE] = "118700:5", [ATLASLOOT_IT_AMOUNT1] = 5 },	-- Greater Draenic Agility Flask (Sold, Ashran)
				{ 7, 109155, 156571, [PRICE_EXTRA_ITTYPE] = "118700:5", [ATLASLOOT_IT_AMOUNT1] = 5 },	-- Greater Draenic Intellect Flask (Sold, Ashran)
				{ 8, 109160, 156576, [PRICE_EXTRA_ITTYPE] = "118700:5", [ATLASLOOT_IT_AMOUNT1] = 5 },	-- Greater Draenic Stamina Flask (Sold, Ashran)
				{ 9, 109156, 156572, [PRICE_EXTRA_ITTYPE] = "118700:5", [ATLASLOOT_IT_AMOUNT1] = 5 },	-- Greater Draenic Strength Flask (Sold, Ashran)
			},
			[MOP_DIFF] = {
			...
			[BC_DIFF] = {
				...
				{ 5, 22853, 28588, [ATLASLOOT_IT_AMOUNT1] = 2 },	-- Flask of Mighty Versatility : =ds=#sr# 300 : =ds=AtlasLoot["Discovery"]
		...
		{	--AlchemyReagents
			name = AL["Reagents"],
			[SL_DIFF] = {
				{ 1, 183942, 343675 }, -- Novice Crafter's Mark
				{ 2, 173381, 343679 }, -- Crafter's Mark I
				{ 3, 173382, 343678 }, -- Crafter's Mark II
			},
			-- [BFA_DIFF] = {
			-- 	{ 1, 000000, 000000 }, -- XXXXXXXXXX
			-- },
			...
			-- },
			[WOD_DIFF] = {
				{ 1, 108996, 156587, [ATLASLOOT_IT_AMOUNT1] = "8+" },	-- Alchemical Catalyst (Learnt by item 109558)
				{ 3, 109123, 156585 },	-- Crescent Oil (Learnt by item 109558)
			},
			-- [MOP_DIFF] = {
			-- 	{ 1, 000000, 000000 }, -- XXXXXXXXXX
			-- },
			[CATA_DIFF] = {
				{ 1, 56850, 80486, [ATLASLOOT_IT_AMOUNT1] = "1-2" },	-- Deepstone Oil : =ds=#sr# 470 : =ds=AtlasLoot["Trainer"]
			},
			[WOTLK_DIFF] = {
				{ 1, 44958, 62409 },	-- Ethereal Oil : =ds=#sr# 375 : =ds=AtlasLoot["Trainer"]
				{ 2, 40195, 53812, [ATLASLOOT_IT_AMOUNT1] = "1-2" },	-- Pygmy Oil : =ds=#sr# 375 : =ds=AtlasLoot["Trainer"]
			},
			-- [BC_DIFF] = {
			-- 	{ 1, 000000, 000000 }, -- XXXXXXXXXX
			-- },
			[CLASSIC_DIFF] = {
				{ 1, 13423, 17551 },	-- Stonescale Oil : =ds=#sr# 250 : =ds=AtlasLoot["Trainer"]
				{ 2, 6371, 7837 },	-- Fire Oil : =ds=#sr# 130 : =ds=AtlasLoot["Trainer"]
				{ 3, 6370, 7836 },	-- Blackmouth Oil : =ds=#sr# 80 : =ds=AtlasLoot["Trainer"]
				{ 4, 9210, 11473 },	-- Ghost Dye : =ds=#sr# 245 : =ds=AtlasLoot["Vendor"]: AtlasLoot_IngameLocales["Feralas"]
				{ 5, 9061, 11456 },	-- Goblin Rocket Fuel : =ds=#sr# 210 : =ds=AtlasLoot["Crafted"]: spell4036
			},
		},
		{	--AlchemyTransmutation
			...
			[BFA_DIFF] = {
				{ 1, 152580, 251306 }, -- Transmute: Herbs to Cloth
				{ 2, 152580, 251310 }, -- Transmute: Ore to Cloth
				{ 4, 160322, 251305 }, -- Transmute: Herbs to Ore
				{ 6, 152581, 251822 }, -- Transmute: Fish to Gems
				{ 7, 152581, 251311 }, -- Transmute: Ore to Gems				
				{ 9, 152582, 251314 }, -- Transmute: Cloth to Skins
				{ 11, 152578, 251309 }, -- Transmute: Ore to Herbs
				{ 13, 165851, 286547 }, -- Transmute: Herbs to Anchors
				{ 16, 160325, 251808 }, -- Transmute: Meat to Pet
				{ 18, 152668, 251832 }, -- Transmute: Expulsom
			},
			[LEGION_DIFF] = {
				-- { #, itemID, spellID },
				...
				{ 16, 137599, 213256 }, -- Transmute: Meat to Pet
				{ 18, 124124, 213257 }, -- Transmute: Blood of Sargeras
				-- 7.3.0
				{ 19, 151568, 247701 }, -- Transmute: Primal Sargerite
			},
			[WOD_DIFF] = {
			...
			[MOP_DIFF] = {
				{ 1, 72104, 130326 },	-- Riddle of Steel : =ds=#sr# 600 : =ds=AtlasLoot["Discovery"]
				{ 2, 72104, 114780 },	-- Transmute: Living Steel : =ds=#sr# 600 : =ds=AtlasLoot["Discovery"]
				{ 3, 72095, 114783 },	-- Transmute: Trillium Bar : =ds=#sr# 600 : =ds=AtlasLoot["Discovery"]
				{ 16, 76132, 114781 },	-- Transmute: Primal Diamond : =ds=#sr# 600 : =ds=AtlasLoot["Discovery"]
				{ 18, 76131, 114784 },	-- Transmute: Primordial Ruby : =ds=#sr# 600 : =ds=AtlasLoot["Discovery"]
				{ 19, 76141, 114777 },	-- Transmute: Imperial Amethyst : =ds=#sr# 575 : =ds=AtlasLoot["Discovery"]
				{ 20, 76142, 114778 },	-- Transmute: Sun's Radiance : =ds=#sr# 575 : =ds=AtlasLoot["Discovery"]
				{ 21, 76140, 114776 },	-- Transmute: Vermilion Onyx : =ds=#sr# 575 : =ds=AtlasLoot["Discovery"]
				{ 22, 76138, 114766 },	-- Transmute: River's Heart : =ds=#sr# 550 : =ds=AtlasLoot["Discovery"]
				{ 23, 76139, 114767 },	-- Transmute: Wild Jade : =ds=#sr# 550 : =ds=AtlasLoot["Discovery"]
			},
			[CATA_DIFF] = {
				{ 1, 54464, 78866, [ATLASLOOT_IT_AMOUNT1] = "14-16" },	-- Transmute: Living Elements : =ds=#sr# 485 : =ds=AtlasLoot["Trainer"]
				{ 3, 58480, 80243 },	-- Transmute: Truegold : =ds=#sr# 525 : =ds=AtlasLoot["Trainer"]
				{ 4, 51950, 80244 },	-- Transmute: Pyrium Bar : =ds=#sr# 520 : =ds=AtlasLoot["Trainer"]				
				{ 16, 52303, 80237, [ATLASLOOT_IT_AMOUNT1] = 2 },	-- Transmute: Shadowspirit Diamond : =ds=#sr# 525 : =ds=AtlasLoot["Trainer"]
				{ 18, 52190, 80245 },	-- Transmute: Inferno Ruby : =ds=#sr# 525 : =ds=AtlasLoot["Trainer"]				
				{ 19, 52195, 80247 },	-- Transmute: Amberjewel : =ds=#sr# 520 : =ds=AtlasLoot["Trainer"]
				{ 20, 52194, 80248 },	-- Transmute: Demonseye : =ds=#sr# 515 : =ds=AtlasLoot["Trainer"]
				{ 21, 52191, 80246 },	-- Transmute: Ocean Sapphire : =ds=#sr# 515 : =ds=AtlasLoot["Trainer"]
				{ 22, 52193, 80250 },	-- Transmute: Ember Topaz : =ds=#sr# 510 : =ds=AtlasLoot["Trainer"]
				{ 23, 52192, 80251 },	-- Transmute: Dream Emerald : =ds=#sr# 505 : =ds=AtlasLoot["Trainer"]
			},
			[WOTLK_DIFF] = {
				{ 1, 35624, 53777 },	-- Transmute: Eternal Air to Earth : =ds=#sr# 400 : =ds=AtlasLoot["Discovery"]
				{ 2, 35622, 53776 },	-- Transmute: Eternal Air to Water : =ds=#sr# 400 : =ds=AtlasLoot["Discovery"]
				{ 3, 35623, 53781 },	-- Transmute: Eternal Earth to Air : =ds=#sr# 400 : =ds=AtlasLoot["Discovery"]
				{ 4, 35627, 53782 },	-- Transmute: Eternal Earth to Shadow : =ds=#sr# 400 : =ds=AtlasLoot["Discovery"]
				{ 5, 35625, 53775 },	-- Transmute: Eternal Fire to Life : =ds=#sr# 400 : =ds=AtlasLoot["Discovery"]
				{ 6, 35622, 53774 },	-- Transmute: Eternal Fire to Water : =ds=#sr# 400 : =ds=AtlasLoot["Discovery"]
				{ 7, 36860, 53773 },	-- Transmute: Eternal Life to Fire : =ds=#sr# 400 : =ds=AtlasLoot["Discovery"]
				{ 8, 35627, 53771 },	-- Transmute: Eternal Life to Shadow : =ds=#sr# 400 : =ds=AtlasLoot["Discovery"]
				{ 9, 35624, 53779 },	-- Transmute: Eternal Shadow to Earth : =ds=#sr# 400 : =ds=AtlasLoot["Discovery"]
				{ 10, 35625, 53780 },	-- Transmute: Eternal Shadow to Life : =ds=#sr# 400 : =ds=AtlasLoot["Discovery"]
				{ 11, 35623, 53783 },	-- Transmute: Eternal Water to Air : =ds=#sr# 400 : =ds=AtlasLoot["Discovery"]
				{ 12, 36860, 53784 },	-- Transmute: Eternal Water to Fire : =ds=#sr# 400 : =ds=AtlasLoot["Discovery"]
				{ 16, 41163, 60350 },	-- Transmute: Titanium : =ds=#sr# 395 : =ds=AtlasLoot["Trainer"]
				{ 18, 41266, 57425 },	-- Transmute: Skyflare Diamond : =ds=#sr# 430 : =ds=AtlasLoot["Trainer"]
				{ 19, 41334, 57427 },	-- Transmute: Earthsiege Diamond : =ds=#sr# 425 : =ds=AtlasLoot["Trainer"]		
				{ 21, 36931, 66658 },	-- Transmute: Ametrine : =ds=#sr# 450 : =ds=AtlasLoot["Trainer"]
				{ 22, 36928, 66662 },	-- Transmute: Dreadstone : =ds=#sr# 450 : =ds=AtlasLoot["Trainer"]
				{ 23, 36934, 66664 },	-- Transmute: Eye of Zul : =ds=#sr# 450 : =ds=AtlasLoot["Trainer"]
				{ 24, 36922, 66660 },	-- Transmute: King's Amber : =ds=#sr# 450 : =ds=AtlasLoot["Trainer"]
				{ 25, 36925, 66663 },	-- Transmute: Majestic Zircon : =ds=#sr# 450 : =ds=AtlasLoot["Trainer"]
				{ 26, 36919, 66659 },	-- Transmute: Cardinal Ruby : =ds=#sr# 440 : =ds=AtlasLoot["Quest Reward"]			
			},
			[BC_DIFF] = {
				{ 1, 21886, 28585 },	-- Transmute: Primal Earth to Life : =ds=#sr# 300 : =ds=AtlasLoot["Discovery"]
				{ 2, 22457, 28583 },	-- Transmute: Primal Fire to Mana : =ds=#sr# 300 : =ds=AtlasLoot["Discovery"]
				{ 3, 22452, 28584 },	-- Transmute: Primal Life to Earth : =ds=#sr# 300 : =ds=AtlasLoot["Discovery"]
				{ 4, 21884, 28582 },	-- Transmute: Primal Mana to Fire : =ds=#sr# 300 : =ds=AtlasLoot["Discovery"]
				{ 5, 21885, 28580 },	-- Transmute: Primal Shadow to Water : =ds=#sr# 300 : =ds=AtlasLoot["Discovery"]
				{ 6, 22456, 28581 },	-- Transmute: Primal Water to Shadow : =ds=#sr# 300 : =ds=AtlasLoot["Discovery"]
				{ 7, 21884, 28566 },	-- Transmute: Primal Air to Fire : =ds=#sr# 350 : =ds=AtlasLoot_IngameLocales["The Sha'tar"] - AtlasLoot["Revered"]
				{ 8, 21885, 28567 },	-- Transmute: Primal Earth to Water : =ds=#sr# 350 : =ds=AtlasLoot_IngameLocales["Sporeggar"] - AtlasLoot["Revered"]
				{ 9, 22452, 28568 },	-- Transmute: Primal Fire to Earth: =ds=#sr# 350 : =ds=AtlasLoot_IngameLocales["Kurenai"] / The Mag'har - AtlasLoot["Revered"]
				{ 10, 22451, 28569 },	-- Transmute: Primal Water to Air : =ds=#sr# 350 : =ds=AtlasLoot_IngameLocales["Cenarion Expedition"] - AtlasLoot["Revered"]
				{ 16, 23571, 29688 },	-- Transmute: Primal Might : =ds=#sr# 350 : =ds=AtlasLoot["Vendor"]
				{ 18, 25867, 32765 },	-- Transmute: Earthstorm Diamond : =ds=#sr# 350 : =ds=AtlasLoot_IngameLocales["Cenarion Expedition"] - AtlasLoot["Honored"]
				{ 19, 25868, 32766 },	-- Transmute: Skyfire Diamond : =ds=#sr# 350 : =ds=AtlasLoot_IngameLocales["Honor Hold"] / Thrallmar - AtlasLoot["Honored"]
			},
			[CLASSIC_DIFF] = {
				{ 1, 7068, 25146, [ATLASLOOT_IT_AMOUNT1] = 3 },	-- Transmute: Elemental Fire : =ds=#sr# 300 : =ds=AtlasLoot["Vendor"]: AtlasLoot_IngameLocales["Blackrock Depths"]
				{ 3, 7078, 17559 },	-- Transmute: Air to Fire : =ds=#sr# 275 : =ds=AtlasLoot_IngameLocales["Argent Dawn"] - AtlasLoot["Honored"]
				{ 4, 12803, 17566 },	-- Transmute: Earth to Life : =ds=#sr# 275 : =ds=AtlasLoot["World Drop"]
				{ 5, 7080, 17561 },	-- Transmute: Earth to Water : =ds=#sr# 275 : =ds=AtlasLoot["Vendor"]: AtlasLoot_IngameLocales["Felwood"]
				{ 6, 7076, 17560 },	-- Transmute: Fire to Earth : =ds=#sr# 275 : =ds=AtlasLoot["Vendor"]: AtlasLoot_IngameLocales["Blackrock Depths"]
				{ 7, 7076, 17565 },	-- Transmute: Life to Earth : =ds=#sr# 275 : =ds=AtlasLoot["World Drop"]
				{ 8, 7080, 17563 },	-- Transmute: Undeath to Water : =ds=#sr# 275 : =ds=AtlasLoot["World Drop"]
				{ 9, 7082, 17562 },	-- Transmute: Water to Air : =ds=#sr# 275 : =ds=AtlasLoot["Vendor"]: AtlasLoot_IngameLocales["Western Plaguelands"]
				{ 10, 12808, 17564 },	-- Transmute: Water to Undeath : =ds=#sr# 275 : =ds=AtlasLoot["World Drop"]
				{ 16, 12360, 17187 },	-- Transmute: Arcanite : =ds=#sr# 275 : =ds=AtlasLoot["Vendor"]: AtlasLoot_IngameLocales["Tanaris"]
				{ 18, 3577, 11479 },	-- Transmute: Iron to Gold : =ds=#sr# 225 : =ds=AtlasLoot["Vendor"]: AtlasLoot_IngameLocales["Tanaris"]
				{ 19, 6037, 11480 },	-- Transmute: Mithril to Truesilver : =ds=#sr# 225 : =ds=AtlasLoot["Vendor"]: AtlasLoot_IngameLocales["Tanaris"]
			},	
		},
		{	--AlchemyConversion
			name = GetSpellInfo(119975),
			[SL_DIFF] = {
				{ 1, 171287, 307120 }, -- Ground Death Blossom
				{ 2, 171290, 307123 }, -- Ground Marrowroot
				{ 3, 171292, 307125 }, -- Ground Nightshade
				{ 4, 171291, 307124 }, -- Ground Rising Glory
				{ 5, 171288, 307121 }, -- Ground Vigil's Torch
				{ 6, 171289, 307122 }, -- Ground Widowbloom
			},
			[BFA_DIFF] = {
				{ 1, 162460, 287234 }, -- Aqueous Dilution
				{ 2, 162461, 286630 }, -- Sanguinated Dilution
			},
			-- [LEGION_DIFF] = {
			-- 	{ 1, 000000, 000000 }, -- XXXXXXXXXX
			-- },
		...
		{	--AlchemyTrinkets
			...
			[BFA_DIFF] = {
				{ 1, 152637, 252368 }, -- Siren's Alchemist Stone
				{ 2, 152637, 252369 }, -- Siren's Alchemist Stone
				{ 3, 152637, 252370 }, -- Siren's Alchemist Stone
				{ 5, 152634, 252361 }, -- Endless Tincture of Renewed Combat
				{ 6, 152634, 252362 }, -- Endless Tincture of Renewed Combat
				{ 7, 152634, 252363 }, -- Endless Tincture of Renewed Combat
				{ 9, 152632, 252379 }, -- Surging Alchemist Stone
				{ 10, 152632, 252380 }, -- Surging Alchemist Stone
				{ 11, 152632, 252381 }, -- Surging Alchemist Stone
				{ 13, 152636, 252376 }, -- Endless Tincture of Fractional Power
				{ 14, 152636, 252377 }, -- Endless Tincture of Fractional Power
				{ 15, 152636, 252378 }, -- Endless Tincture of Fractional Power
				{ 16, 166974, 291084 }, -- Sanguinated Alchemist Stone
				{ 17, 166975, 291085 }, -- Imbued Alchemist Stone
				{ 18, 165926, 286921 }, -- Tidal Alchemist Stone
				{ 19, 166976, 291086 }, -- Emblazoned Alchemist Stone				
				{ 20, 165927, 286922 }, -- Spirited Alchemist Stone
				{ 21, 168674, 298995 }, -- Abyssal Alchemist Stone
				{ 22, 165928, 286923 }, -- Eternal Alchemist Stone	
				{ 23, 168675, 298996 }, -- Crushing Alchemist Stone
				{ 24, 168676, 298997 }, -- Ascended Alchemist Stone
				{ 25, 171088, 305994 }, -- Unbound Alchemist Stone
				{ 26, 171087, 305993 }, -- Awakened Alchemist Stone
				{ 27, 171085, 305992 }, -- Peerless Alchemist Stone
			},
			[LEGION_DIFF] = {
			...
			[WOD_DIFF] = {
				...
				{ 3, 128024, 188676 },	-- Stone of the Elements
				{ 4, 128023, 188674 },	-- Stone of the Wilds
				{ 5, 122604, 181650 },	-- Stone of Fire
				{ 6, 122603, 181649 },	-- Stone of the Waters
				{ 7, 122602, 181648 },	-- Stone of the Earth
				{ 8, 122601, 181647 },	-- Stone of Wind
			},
			[MOP_DIFF] = {
			...
			[BC_DIFF] = {
				{ 1, 31080, 38070 },	-- Mercurial Stone : =ds=#sr# 325 : =ds=AtlasLoot["Trainer"]
				{ 3, 13503, 17632 },	-- Alchemist's Stone : =ds=#sr# 350 : =ds=AtlasLoot_IngameLocales["The Sha'tar"] - AtlasLoot["Revered"]
				{ 5, 35751, 47050 },	-- Assassin's Alchemist Stone : =ds=#sr# 375 : =ds=AtlasLoot_IngameLocales["Shattered Sun Offensive"] - AtlasLoot["Exalted"]
				{ 6, 35748, 47046 },	-- Guardian's Alchemist Stone : =ds=#sr# 375 : =ds=AtlasLoot_IngameLocales["Shattered Sun Offensive"] - AtlasLoot["Exalted"]
				{ 7, 35750, 47049 },	-- Redeemer's Alchemist Stone : =ds=#sr# 375 : =ds=AtlasLoot_IngameLocales["Shattered Sun Offensive"] - AtlasLoot["Exalted"]
				{ 8, 35749, 47048 },	-- Sorcerer's Alchemist Stone : =ds=#sr# 375 : =ds=AtlasLoot_IngameLocales["Shattered Sun Offensive"] - AtlasLoot["Exalted"]
			},
			[CLASSIC_DIFF] = {
				{ 1, 9149, 11459 },	-- Philosopher's Stone : =ds=#sr# 225 : =ds=AtlasLoot["Vendor"]: AtlasLoot_IngameLocales["Tanaris"]
			},
		},
		{	--AlchemyMisc
			name = AL["Miscellaneous"],
			[SL_DIFF] = {
				{ 1, 182072, 338204 }, -- Bramblethorn Juice
				{ 2, 182047, 338199 }, -- Brutal Oil
				{ 3, 182048, 338200 }, -- Crushed Bones
				{ 4, 182025, 338195 }, -- Distilled Resolve
				{ 5, 181858, 338198 }, -- Draught of Grotesque Strength
				{ 6, 181857, 338202 }, -- Elixir of Humility
				{ 7, 181859, 338194 }, -- Flask of Measured Discipline
				{ 8, 181983, 338191 }, -- Liquid Sleep
				{ 9, 181375, 338190 }, -- Potion of Hibernal Rest
				{ 10, 181984, 338192 }, -- Powdered Dreamroot
			...
			[BFA_DIFF] = {
				...
				{ 2, 165721, 287288 }, -- Vial of Obfuscation
				{ 4, 171320, 307172 }, -- Void Focus
				{ 6, 156631, 260403 }, -- Silas' Sphere of Transmutation			
			},
			-- [LEGION_DIFF] = {
			-- 	{ 1, 000000, 000000 }, -- XXXXXXXXXX
			-- },
