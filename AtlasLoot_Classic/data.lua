...
data["Darkmaul Citadel"] = {
	...
	items = {
		{	--Tunk
			...
			name = "Tunk",
			[NORMAL_DIFF] = {
				{ 1, 178176 },	-- Tunk's Trunk
				{ 3, 178164 },	-- Tunk's Needle
				{ 4, 178167 },	-- Tunk's Lil' Whomper
				{ 5, 178165 },	-- Tunk's Tooth
				{ 6, 178162 },	-- Tunk's Whomper
				{ 7, 178166 },	-- Tunk's Toothpick
				{ 8, 179362 },	-- Tunk's Backscratcher
				{ 9, 179360 },	-- Tunk's Tiny Bow
				{ 10, 178163 },	-- Tunk's Shinguard
			},
		},
		{	--Ravnyr
			--EncounterJournalID = 0000,
			...
			name = "Ravnyr",
			[NORMAL_DIFF] = {
				{ 1, 178169 },	-- Decrepit Dragonscale Drape
				{ 2, 178171 },	-- Darkmaul Signet Ring
				{ 3, 178168 },	-- Darkmaul Ritual Stone
			},
		},
	},
}
