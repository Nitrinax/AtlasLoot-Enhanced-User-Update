...
-- WoW
local GetAchievementInfo, EJ_GetEncounterInfo = GetAchievementInfo, EJ_GetEncounterInfo
-- ----------------------------------------------------------------------------
-- AddOn namespace.
-- ----------------------------------------------------------------------------
local addonname = ...
...
local CATA_SHARED_WB_LOOT = {
	name = AL["Shared Boss Loot"],
	ExtraList = true,
	[NORMAL_DIFF] = {
		{ 1, 67150 }, -- Arrowsinger Legguards
		{ 2, 67139 }, -- Blauvelt's Family Crest
		{ 3, 67145 }, -- Blockade's Lost Shield
		{ 4, 67138 }, -- Buc-Zakai Choker
		{ 5, 67141 }, -- Corefire Legplates
		{ 6, 67133 }, -- Dizze's Whirling Robe
		{ 7, 67137 }, -- Don Rodrigo's Fabulous Necklace
		{ 8, 67130 }, -- Dorian's Lost Necklace
		{ 9, 67134 }, -- Dory's Finery
		{ 10, 67140 }, -- Drape of Inimitable Fate
		{ 11, 67136 }, -- Gilnean Ring of Ruination
		{ 12, 67132 }, -- Grips of the Failed Immortal
		{ 13, 67149 }, -- Heartbound Tome
		{ 14, 67143 }, -- Icebone Hauberk
		{ 15, 67147 }, -- Je'Tze's Sparkling Tiara
		{ 16, 67148 }, -- Kilt of Trollish Dreams
		{ 17, 67135 }, -- Morrie's Waywalker Wrap
		{ 18, 67144 }, -- Pauldrons of Edward the Odd
		{ 19, 67131 }, -- Ritssyn's Ruminous Drape
		{ 20, 67129 }, -- Signet of High Arcanist Savor
		{ 21, 67146 }, -- Woundsplicer Handwraps
		{ 22, 67142 }, -- Zom's Electrostatic Cloak
		{ 24, 68787 }, -- Formula: Enchant Bracer - Agility
		{ 25, 68788 }, -- Formula: Enchant Bracer - Major Strength
		{ 26, 68789 }, -- Formula: Enchant Bracer - Mighty Intellect
		{ 28, 68781 }, -- Design: Agile Shadowspirit Diamond
		{ 29, 68783 }, -- Design: Burning Shadowspirit Diamond
		{ 30, 68782 }, -- Design: Reverberating Shadowspirit Diamond
	},
}
...
-- Whale Shark (no loot, only achievement)
-- Xariona
...
data["Azeroth"] = {
	...
	items = 
	{
		{	-- Akma'hat <Dirge of the Eternal Sands>
			...
			-- no EncounterJournalID available
			name = AL["CatWB_Akmahat"],
			[NORMAL_DIFF] = {
		...
		{	-- Garr
			...
			name = AL["CatWB_Garr"],
			[NORMAL_DIFF] = {
				{ 1, 69842 }, -- Garr's Reinforced Girdle of Memories
			},
		},
		{	-- Julak-Doom <The Eye of Zor>
			-- EncounterJournalID = 0000,
			-- no EncounterJournalID available
			name = AL["CatWB_JulakDoom"],
			[NORMAL_DIFF] = {
				{ 1, 69844 }, -- Vitreous Beak of Julak-Doom
			},
		},
		{	-- Mobus <The Crushing Tide>
			-- EncounterJournalID = 0000,
			...
			name = AL["CatWB_Mobus"],
			[NORMAL_DIFF] = {
				{ 1, 69843 }, -- Mobus's Dripping Halberd
			},
		},
		{	-- Whale Shark
			-- EncounterJournalID = 0000,
			-- no EncounterJournalID available
			name = AL["CatWB_WhaleShark"],
			[NORMAL_DIFF] = {
				{ 1, "ac4975" }, -- From Hell's Heart I Stab at Thee
			},
		},
		{	-- Xariona
			-- EncounterJournalID = 0000,
			-- no EncounterJournalID available
			name = AL["CatWB_Xariona"],
			[NORMAL_DIFF] = {
				{ 1, 69876 }, -- Xariona's Spectral Gauntlets
			},
		},
		CATA_SHARED_WB_LOOT,
	}
