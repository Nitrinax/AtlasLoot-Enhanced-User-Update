...
local LEGION_MAX_UPGRADELVL = 54
local BFA_MAX_UPGRADELVL = 140
local SL_MAX_UPGRADELVL = 233
...
local ITEM_BONUS_PRESET = {
	...
	-- ## SL
	["SLMaxItemLvl"] = function(itemID, difficultyID, baseLvl)
		return GetScaledItem(itemID, difficultyID, SL_MAX_UPGRADELVL)
	end,
	-- Raids
	["LFR"]					= { 451 },
	["SoOWarforged"]			= { 448 },
